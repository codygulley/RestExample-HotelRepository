package com.testwebservices.hotel.test;
...
import com.testwebservices.hotel.Application;
import com.testwebservices.hotel.api.rest.HotelController;
...
public class HotelControllerTest {
    ...
    private static final String RESOURCE_LOCATION_PATTERN = "http://localhost/hotel/v1/hotels/[0-9]+";
    ...
    public void shouldHaveEmptyDB() throws Exception {
        mvc.perform(get("/hotel/v1/hotels")
    ...
    public void shouldCreateRetrieveDelete() throws Exception {
        ...
        //CREATE
        MvcResult result = mvc.perform(post("/hotel/v1/hotels")
                .content(r1Json)
        ...
        //RETRIEVE
        mvc.perform(get("/hotel/v1/hotels/" + id)
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
        ...
        //DELETE
        mvc.perform(delete("/hotel/v1/hotels/" + id))
                .andExpect(status().isOk());
 ...
 */
    ...
    public void shouldCreateAndUpdateAndDelete() throws Exception {
        ...
        //UPDATE
        result = mvc.perform(put("/hotel/v1/hotels/" + id)
                .content(r2Json)
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
