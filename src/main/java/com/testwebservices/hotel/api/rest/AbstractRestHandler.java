...
import com.testwebservices.hotel.domain.RestErrorInfo;
import com.testwebservices.hotel.exception.DataFormatException;
import com.testwebservices.hotel.exception.ResourceNotFoundException;
...
public abstract class AbstractRestHandler implements ApplicationEventPublisherAware {
    ...
    RestErrorInfo handleDataStoreException(DataFormatException ex, WebRequest request, HttpServletResponse response) {
        ...
        return new RestErrorInfo(ex, "Error");
    }
    ...
    public static <T> T checkResourceFound(final T resource) {
        if (resource == null) {
            throw new ResourceNotFoundException("resource not found using ID");
        }
        return resource;
    }
